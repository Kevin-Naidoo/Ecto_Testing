defmodule Ept.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule EptWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :ept

       ...

       plug PromEx.Plug, prom_ex_module: Ept.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      #Plugins.Beam
      # {Plugins.Phoenix, router: EptWeb.Router, endpoint: EptWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:ept, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
